      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-5">
          ...
          <div className="relative group">
            <Link href="/services" className="text-sm font-semibold leading-6 text-black flex items-center">
            <span>Service</span>
            ...
            <div className="absolute left-0 mt-2 w-48 bg-white border border-gray-200 shadow-lg hidden group-hover:block rounded-lg">
              <Link href="/contact" className="block px-4 py-2 text-black text-sm font-normal hover:bg-gray-100 rounded-t-lg">SI事業</Link>
              <Link href="/" className="block px-4 py-2 text-black text-sm font-normal hover:bg-gray-100 rounded-b-lg">コンサルティング事業</Link>
            </div>
          </div>
