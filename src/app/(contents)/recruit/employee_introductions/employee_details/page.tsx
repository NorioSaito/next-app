...
function Employee_Details() {
						...
						<div className="flex items-center justify-center">
							<div className="w-[751px] mb-[26px] grid-cols-3 justify-start">
								<div className="flex items-center justify-start">
									<h2 className="w-[50px] pr-[110px] text-af-lg font-bold">Q1</h2>
	...
	テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキス</p>
						...
						<div className="mt-[100px] flex items-center justify-center">
							<div className="w-[751px] mb-[26px] grid-cols-2 justify-start">
								<div className="flex items-center justify-start">
									<h2 className="w-[50px] pr-[110px] text-af-lg font-bold">Q2</h2>
	...
	テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキス</p>
						...
						<div className="mt-[100px] flex items-center justify-center">
							<div className="w-[751px] mb-[26px] grid-cols-3 justify-start">
								<div className="flex items-center justify-start">
									<h2 className="w-[50px] pr-[110px] text-af-lg font-bold">Q3</h2>
	...
	テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキス</p>
						...
						<div className="mt-[100px] flex items-center justify-center">
							<div className="w-[751px] mb-[26px] grid-cols-2 justify-start">
								<div className="flex items-center justify-start">
									<h2 className="w-[50px] pr-[110px] text-af-lg font-bold">Q4</h2>
	...
	テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキス</p>
						...
						<div className="mt-[100px] flex items-center justify-center">
							<div className="w-[751px] mb-[26px] grid-cols-3 justify-start">
								<div className="flex items-center justify-start">
									<h2 className="w-[50px] pr-[110px] text-af-lg font-bold">Q5</h2>
				...
				<section>
					<div className="mt-[80px] flex items-center justify-center">
						<div className="mb-[26px] grid-cols-4 justify-center">
							<h2 className="text-af-lg font-bold text-center">Q6</h2>
							<p className="text-af-md font-bold text-center tracking-wide">ひとことメッセージ</p>
							<div className="relative mt-[51px] w-[373px] h-[373px]">
								...
								<Image src="/A-force_horizon.svg" alt="" width={500} height={373} className="bg-[#ffffff] relative w-full h-full border border-af-black rounded-t-[186.5px] rounded-b-[16px] z-10"/>
							</div>
						</div>
					</div>
				</section>
