					...
					<div className="w-[400px] mt-[72px] border border-af-black rounded-[16px] tracking-wide bg-[#ffffff]">
						...
						<div className="px-[40px] mb-[26px] grid-cols-6 ">
							<div className="flex items-center">
								...
								<p
									className="text-af-xs hover:underline"
									onClick={handleScrollToQ1}
								>
									エイ・フォースってどんな会社？
								</p>
							</div>
						...
						<div className="flex items-center justify-center">
							<div className="w-[751px] mb-[26px] grid-cols-3 justify-start">
								<div className="flex items-center justify-start">
									<h2
										id="targetQ1"
										className="w-[50px] pr-[110px] text-af-lg font-bold"
									>
										Q1
									</h2>
									<p className="text-af-md font-bold tracking-wide">
										エイ・フォースってどんな会社？
									</p>
								</div>
								<div className="pt-[41px] flex items-center">
									<p className="text-af-xs leading-[2.4] tracking-wide">
				...
				<section>
					<div className="mt-[80px] flex items-center justify-center">
						<div className="mb-[26px] grid-cols-4 justify-center">
							<h2 id="targetQ6" className="text-af-lg font-bold text-center">
								Q6
							</h2>
							<p className="text-af-md font-bold text-center tracking-wide">
								ひとことメッセージ
							</p>
							<div className="relative mx-auto mt-[51px] w-[373px] h-[373px]">
								...
								<Image
									...
									width={373}
									height={373}
									className="bg-[#ffffff] relative w-full h-full border border-af-black rounded-t-[186.5px] rounded-b-[16px] z-10"
								/>
							</div>
							<p className="pt-[60px] w-[445px] text-af-xs leading-[1.6] tracking-wide">
