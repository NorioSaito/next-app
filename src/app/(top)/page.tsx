	...
	return (
		<main className="">
			<motion.section
				...
				variants={variants}
				className="flex items-start mx-20"
			>
				<Image
					className="pb-24"
					src="top_Alogo.svg"
			...
			<motion.section
				...
				variants={variants}
				className="flex flex-col items-center justify-center mx-20 pt-64"
			>
				<div className="flex">
					<Image
						className="pb-20"
			...
			<motion.section
				...
				viewport={{ once: true, amount: 0.5 }}
				variants={variants}
				className="bg-gray-950 px-20 pt-20"
			>
				<div className="flex">
			...
			<motion.section
				...
				viewport={{ once: true, amount: 0.5 }}
				variants={variants}
				className="flex flex-col items-center justify-center mx-20 my-10 pt-48"
			>
				<div className="flex">
					<Image
						className="pb-20"
